...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Коробка не переключает скорости вверх",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Частая причина — постоянно горящие стоп-сигналы из-за отвалившейся резиновой шайбы на педали тормоза под лягушкой (датчиком). Проверьте, не горят ли стопы постоянно, и восстановите шайбу/датчик."
      }
    },
    {
      "@type": "Question",
      "name": "Уводит машину в сторону после сход-развала",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Причина — криво выставленный с завода подрамник. Замерьте расстояние от края переднего колеса до крыла слева и справа: разница 5–7 мм и более указывает на смещение. Решение: на подъёмнике ослабить болты подрамника, выровнять его по кузову, затянуть с нужным моментом и повторить сход-развал."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Обновите у дилера прошивку блока климата до версии 9117. Альтернатива — поставить переходник для климата Geely Tugella/Coolray."
      }
    },
    {
      "@type": "Question",
      "name": "Стук в подвеске",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Чаще всего изношены втулки переднего стабилизатора (износ слабо заметен). Решение — замена втулок или узла в сборе и контрольный сход-развал."
      }
    },
    {
      "@type": "Question",
      "name": "«Отвал» стеклоподъёмника",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Быстрый сброс блока: вынуть предохранитель №33 (30A) «стеклоподъёмники», через 10–15 секунд вставить обратно."
      }
    },
    {
      "@type": "Question",
      "name": "Скрипит люк при закрытии",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Смазывайте подвижные части и резинки каждые ~6 месяцев или 5 000 км. Для резинок используйте силиконовую смазку."
      }
    },
    {
      "@type": "Question",
      "name": "Стук под капотом справа",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "В районе бачков омывателя и охлаждающей жидкости патрубок соприкасается с пластиковой крышкой. Проложите участок поролоном или зафиксируйте антискрип-лентой — шум исчезнет."
      }
    }
  ]
}
