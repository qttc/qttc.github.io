...
![Бот](/assets/bot-functions.png "Функции бота")

Если у вас не отображаются кнопки, нажмите на иконку 
![Активация кнопок в боте](/assets/bot-activate-buttons.png)
...
![Версия ПО](/assets/po-version.png "Версия ПО")
