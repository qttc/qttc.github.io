...
### Облегченные версии Community {#lite}
...
### Как пользоваться ботом? {#bot-usage}
...
### Пошаговая инструкция по установке {#install-steps}
1. **Узнать версию ПО в машине.**
Подробнее - [Как узнать версию ПО в машине?](#check-version)
...
Подробнее - [Как пользоваться ботом?](#bot-usage)
4. **Скачать архив на комп.**
5. **Подготовить флешку.**
Подробнее - [Какая флешка нужна для установки Community?](#usb-flash)
6. **Разархивировать архив и скопировать на флешку.**
Подробнее - [Как правильно разархивировать файлы на флешку?](#unzip)
7. **Достать флешку и пойти к машине.**
8. **Воткнуть флешку в USB порт машины.**
Подробнее - [В какой порт вставлять флешку?](#usb-port)
...
### Как узнать версию ПО в машине? {#check-version}
...
### Какая флешка нужна для установки Community? {#usb-flash}
...
### В какой порт вставлять флешку? {#usb-port}
В любой порт - не важно левый или правый.

_[К оглавлению](#toc)_

### Как правильно разархивировать файлы на флешку? {#unzip}
...
![Структура файлов](../assets/flash-files.jpg)
